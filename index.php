...
/* 
  ...
  * WHERE I select the column completed in my database, the $undone_data will have 0 and the $done_data will have 1. 
  * In the database it will do the change from 0 to 1 and the other way around depending if the user want to mark it as done or unmark it again to become an unfinished task again. 
